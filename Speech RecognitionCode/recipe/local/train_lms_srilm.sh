...
echo "------------------------"
ngram-count -lm $tgtdir/1gram.kn01.gz -addsmooth1 0 -addsmooth2 0 -addsmooth3 0 -order 3 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
ngram-count -lm $tgtdir/1gram.kn02.gz -kndiscount1 -gt1min 0 -kndiscount2 -gt2min 2 -order 1 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
ngram-count -lm $tgtdir/2gram.gt10.gz -gt1min 0 -gt2min 1 -order 2 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
ngram-count -lm $tgtdir/2gram.gt01.gz -gt1min 1 -gt2min 0 -order 2 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
...
ngram-count -lm $tgtdir/3gram.gt101.gz -gt1min 1 -gt2min 0 -gt3min 1 -order 3 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
ngram-count -lm $tgtdir/3gram.gt110.gz -gt1min 1 -gt2min 1 -gt3min 0 -order 3 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"

ngram-count -lm $tgtdir/4gram.gt1011.gz -gt1min 1 -gt2min 0 -gt3min 1 -gt4min 1 -order 4 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
...
ngram-count -lm $tgtdir/4gram.gt1101.gz -gt1min 1 -gt2min 1 -gt3min 0 -gt4min 1 -order 4 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
ngram-count -lm $tgtdir/4gram.gt1110.gz -gt1min 0 -gt2min 1 -gt3min 1 -gt4min 0 -order 4 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
...
echo "--------------------"
(
  for f in $tgtdir/4gram* $tgtdir/3gram* $tgtdir/2gram* $tgtdir/1gram* ; do ( echo $f; ngram -order 3 -lm $f -unk -map-unk "$oov_symbol" -ppl $tgtdir/dev.txt ) | paste -s -d ' ' - ; done
